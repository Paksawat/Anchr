const translations = {
  en: {
    ...
    // Onboarding
    welcome_to_anchr: 'Welcome to Anchr',
    onboarding_welcome_subtitle: 'Your personal companion for breaking free from unwanted habits and urges.',
    onboarding_welcome_desc: 'Anchr gives you the tools to understand your urges, ride them out, and build lasting change — one moment at a time.',
    onboarding_point_1: 'Start a timer when an urge hits and ride it out with guided tools.',
    onboarding_point_2: 'Track your streak, triggers, and patterns to understand yourself better.',
    onboarding_point_3: 'Write personal motivations to come back to when things get hard.',
    onboarding_get_started: 'Get started',
    onboarding_how_title: 'How Anchr works',
    onboarding_feature_1_title: 'Urge Timer',
    onboarding_feature_1_desc: 'When an urge hits, start a guided timer. Breathe, ground yourself, and use coping tools — urges pass in minutes.',
    onboarding_feature_2_title: 'Progress Tracking',
    onboarding_feature_2_desc: 'Watch your streak grow, see which triggers affect you most, and find your peak risk times.',
    onboarding_feature_3_title: 'Motivation Wall',
    onboarding_feature_3_desc: 'Add personal messages to yourself. Read them when you need a reminder of why you started.',
    onboarding_resources_title: 'Where to get help',
    onboarding_resource_1: 'Talk to your doctor or a mental health professional.',
    onboarding_resource_2: 'Contact a local addiction support service or helpline.',
    onboarding_resource_3: 'Reach out to a trusted person in your life.',
    accept_and_continue: 'I understand — continue',
    onboarding_urge_title: 'What are you working on?',
    onboarding_urge_subtitle: 'This personalises your experience. You can change it later in Settings.',
    ...
    disclaimer_text: 'Anchr is not a medical or therapeutic service. If you are struggling with addiction or mental health, please seek help from a qualified professional.',
    disclaimer_accept: 'I understand that Anchr is not a medical service and I should seek professional help if needed.',

    // Privacy & GDPR
    privacy_accept_text: 'I have read and accept the Privacy Policy.',
    ...
    consent_required: 'You must accept the Privacy Policy and agree to data storage to create an account.',

    // Password validation & signup
    password_invalid: 'Password must be at least 6 characters and contain at least 1 number.',
    passwords_no_match: 'Passwords do not match.',
    confirm_password: 'Confirm Password',
    confirm_password_placeholder: 'Repeat your password',
    password_create_placeholder: 'At least 6 chars + 1 number',
    ...
    reset_sent_desc: 'If an account with that email exists, a reset link has been sent. Check your inbox and spam folder.',
    ...
    reset_success_desc: 'Your password has been changed. Redirecting you to sign in...',
    reset_expired_title: 'Link expired',
    reset_expired_desc: 'This reset link has expired or already been used.',
    reset_resend_prompt: 'Enter your email to get a new link.',
    reset_resend_sent: 'A new reset link has been sent to your email.',
    ...
    return_to_timer: 'Return to timer',
...
For privacy questions, contact us through the app.`,
  ...
  da: {
    ...
    most_urges_on: 'Den stærkeste trang sker om',
    no_time_data: 'Ingen tidsdata endnu',
    peak_hour_label: 'Spidstime',
    other_hours_label: 'Andre timer',
    peak_day_label: 'Spidsdag',
    other_days_label: 'Andre dage',
    by_hour: 'Time',
    by_day: 'Dag',
    year: 'År',
    ...
    // Onboarding
    welcome_to_anchr: 'Velkommen til Anchr',
    onboarding_welcome_subtitle: 'Din personlige ledsager til at bryde fri fra uønskede vaner og trang.',
    onboarding_welcome_desc: 'Anchr giver dig værktøjerne til at forstå din trang, ride den ud og skabe varig forandring — ét øjeblik ad gangen.',
    onboarding_point_1: 'Start en timer, når trangen rammer, og rid den ud med guidede værktøjer.',
    onboarding_point_2: 'Spor din streak, dine udløsere og mønstre for at forstå dig selv bedre.',
    onboarding_point_3: 'Skriv personlige motivationer at vende tilbage til, når det bliver svært.',
    onboarding_get_started: 'Kom i gang',
    onboarding_how_title: 'Sådan virker Anchr',
    onboarding_feature_1_title: 'Trang-timer',
    onboarding_feature_1_desc: 'Når trangen rammer, start en guidet timer. Ånd, grund dig selv, og brug mestringsværktøjer — trang går over på få minutter.',
    onboarding_feature_2_title: 'Fremskridtssporing',
    onboarding_feature_2_desc: 'Se din streak vokse, find ud af hvilke udløsere der påvirker dig mest, og find dine spidsrisikoer.',
    onboarding_feature_3_title: 'Motivationsvæg',
    onboarding_feature_3_desc: 'Tilføj personlige beskeder til dig selv. Læs dem, når du har brug for at huske, hvorfor du startede.',
    onboarding_resources_title: 'Hvor du kan få hjælp',
    onboarding_resource_1: 'Tal med din læge eller en psykisk sundhedsprofessionel.',
    onboarding_resource_2: 'Kontakt en lokal afhængighedsrådgivning eller hjælpelinje.',
    onboarding_resource_3: 'Ræk ud til en person du stoler på i dit liv.',
    accept_and_continue: 'Jeg forstår — fortsæt',
    onboarding_urge_title: 'Hvad arbejder du på?',
    onboarding_urge_subtitle: 'Dette personaliserer din oplevelse. Du kan ændre det senere i Indstillinger.',
    go_to_dashboard: 'Gå til oversigt',
    skip: 'Spring over',
    continue: 'Fortsæt',

    // Disclaimer
    disclaimer_title: 'Vigtig besked',
    disclaimer_text: 'Anchr er ikke en medicinsk eller terapeutisk service. Hvis du kæmper med afhængighed eller mental sundhed, bedes du søge hjælp hos en kvalificeret fagperson.',
    disclaimer_accept: 'Jeg forstår, at Anchr ikke er en medicinsk service, og at jeg bør søge professionel hjælp hvis nødvendigt.',

    // Privacy & GDPR
    privacy_accept_text: 'Jeg har læst og accepteret Privatlivspolitikken.',
    ...
    consent_required: 'Du skal acceptere Privatlivspolitikken og datapolitikken for at oprette en konto.',

    // Password validation & signup
    password_invalid: 'Adgangskoden skal være mindst 6 tegn og indeholde mindst 1 tal.',
    passwords_no_match: 'Adgangskoderne stemmer ikke overens.',
    confirm_password: 'Bekræft adgangskode',
    confirm_password_placeholder: 'Gentag din adgangskode',
    password_create_placeholder: 'Mindst 6 tegn + 1 tal',

    // Forgot / reset password
    forgot_password: 'Glemt adgangskode?',
    forgot_title: 'Glemt adgangskode',
    forgot_subtitle: 'Indtast din e-mail, og vi sender dig et nulstillingslink.',
    send_reset_link: 'Send nulstillingslink',
    back_to_login: 'Tilbage til log ind',
    reset_sent_title: 'Tjek din e-mail',
    reset_sent_desc: 'Hvis der eksisterer en konto med den e-mail, er et nulstillingslink sendt. Tjek din indbakke og spam-mappe.',
    reset_title: 'Sæt ny adgangskode',
    reset_subtitle: 'Vælg en ny adgangskode til din konto.',
    set_new_password: 'Sæt ny adgangskode',
    new_password: 'Ny adgangskode',
    reset_success_title: 'Adgangskode opdateret',
    reset_success_desc: 'Din adgangskode er ændret. Du omdirigeres til log ind...',
    reset_expired_title: 'Link udløbet',
    reset_expired_desc: 'Dette nulstillingslink er udløbet eller allerede brugt.',
    reset_resend_prompt: 'Indtast din e-mail for at få et nyt link.',
    reset_resend_sent: 'Et nyt nulstillingslink er sendt til din e-mail.',
    resend_wait: 'Send igen om',
    ...
    return_to_timer: 'Gå tilbage til timer',
