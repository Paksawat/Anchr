    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#F9F8F6' }}>
      <div className="w-full max-w-md" data-testid="auth-page">
        ...
        <div className="rounded-3xl p-8 shadow-sm" style={{ background: '#FFFFFF', border: '1px solid #E8E6E1' }}>
          ...
          {error && (
            <div data-testid="auth-error" className="mb-4 p-3 rounded-xl text-sm" style={{ background: '#FDF2F2', color: '#E5989B', border: '1px solid #E5989B33' }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {!isLogin && (
              <div>
                <Label className="text-sm mb-2 block" style={{ color: '#7A8B85' }}>Name</Label>
            ...
            <div>
              <Label className="text-sm mb-2 block" style={{ color: '#7A8B85' }}>Email</Label>
              <div className="relative">
            ...
            <div>
              <Label className="text-sm mb-2 block" style={{ color: '#7A8B85' }}>Password</Label>
              <div className="relative">
            ...
            <Button
              ...
              style={{ background: '#6B9080', hover: '#5A7A6C' }}
            >
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-xs" style={{ color: '#A3B1AA' }}>or</span>
            <div className="flex-1 h-px" style={{ background: '#E8E6E1' }} />
          </div>
